...
router.post('/create', removeCache(['/carts']), async (req, res) => {
    const response = new ResponseModel()
    try {
...
router.put('/update', removeCache(['/carts']), async (req, res) => {
    const response = new ResponseModel()
    try {
...
router.delete('/delete', removeCache(['/carts']), async (req, res) => {
    const response = new ResponseModel()
    try {
        const { id } = req.body
        if (!id) {
