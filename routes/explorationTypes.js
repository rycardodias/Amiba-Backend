...
router.post('/create', removeCache(['/explorationTypes']), async (req, res) => {
    const response = new ResponseModel()
    try {
...
router.put('/update', removeCache(['/explorationTypes', '/explorations']), async (req, res) => {
    const response = new ResponseModel()
    try {
...
router.delete('/delete', removeCache(['/explorationTypes']), async (req, res) => {
    const response = new ResponseModel()
    try {
        const { id } = req.body
        if (!id) {
