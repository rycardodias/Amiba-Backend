...
const q1 = await db.query("CREATE FUNCTION public.tr_fc_animalproducts_insert() RETURNS trigger LANGUAGE \'plpgsql\' COST 100 VOLATILE NOT LEAKPROOF AS $BODY$ DECLARE	v_unit varchar(50); BEGIN " +
...
const q2 = await db.query("CREATE TRIGGER \"tr_animalProducts_insert\"BEFORE INSERT ON public.\"AnimalProducts\" FOR EACH ROW " +
