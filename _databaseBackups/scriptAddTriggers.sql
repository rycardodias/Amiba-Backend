...
CREATE TRIGGER tr_logs_general AFTER INSERT OR UPDATE OR DELETE ON "Menus"  FOR EACH ROW EXECUTE PROCEDURE tr_fc_logs();
...
CREATE TRIGGER tr_logs_general AFTER INSERT OR UPDATE OR DELETE ON "Restaurants"  FOR EACH ROW EXECUTE PROCEDURE tr_fc_logs();
...
CREATE TRIGGER tr_logs_general AFTER INSERT OR UPDATE OR DELETE ON "EggsBatchLines"  FOR EACH ROW EXECUTE PROCEDURE tr_fc_logs();
